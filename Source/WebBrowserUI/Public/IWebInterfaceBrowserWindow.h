...
#if WITH_CEF3
	/**
	 * Checks if the web browser is using accelerated paint
	 */
	virtual bool IsUsingAcceleratedPaint() const = 0;

	/**
	 * Checks if the web browser has a DX11On12 interop
	 */
	virtual bool HasAcceleratedPaintInterop() const = 0;
#endif
...
public:
	...
	virtual FOnConsoleLogDelegate& OnConsoleLog() = 0;
	...
	virtual FOnMouseLost& OnMouseLost() = 0;
#endif
