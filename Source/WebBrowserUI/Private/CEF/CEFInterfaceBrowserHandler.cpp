...
)
{
	...
	{
#if PLATFORM_WINDOWS
		BrowserWindow->OnAcceleratedPaint(Type, DirtyRects, Info.shared_texture_handle);
#else
...
CefResourceRequestHandler::ReturnValue FCEFInterfaceBrowserHandler::OnBeforeResourceLoad(CefRefPtr<CefBrowser> Browser, CefRefPtr<CefFrame> Frame, CefRefPtr<CefRequest> Request,
#if PLATFORM_WINDOWS
	CefRefPtr<CefCallback> Callback
#else
	CefRefPtr<CefRequestCallback> Callback
