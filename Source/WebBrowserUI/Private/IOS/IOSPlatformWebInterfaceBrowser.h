...
class SIOSWebInterfaceBrowserWidget;
...
*/
#if !PLATFORM_TVOS
@interface IOSWebInterfaceViewWrapper : NSObject <WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>
#else
@interface IOSWebInterfaceViewWrapper : NSObject
#endif
{
	TSharedPtr<SIOSWebInterfaceBrowserWidget> WebBrowserWidget;
...
#if !PLATFORM_TVOS
@interface IOSWebInterfaceSchemeHandler : NSObject <WKURLSchemeHandler>
...
private:
	...
	TSharedPtr<SIOSWebInterfaceBrowserWidget> BrowserWidget;
