...
// Wrapper for com/epicgames/unreal/WebInterfaceViewControl.java
class FJavaAndroidWebInterfaceBrowser : public FJavaClassObject
{
public:
	FJavaAndroidWebInterfaceBrowser(bool swizzlePixels, bool vulkanRenderer, int32 width, int32 height, jlong widgetPtr, bool bEnableRemoteDebugging, bool bUseTransparency, bool bEnableDomStorage, bool bShouldUseBitmapRender);
	virtual ~FJavaAndroidWebInterfaceBrowser();
	void Release();
